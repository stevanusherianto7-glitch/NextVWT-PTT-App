  ...
  describe('checkDomainAuthorization', () => {
    it('allows localhost', () => {
      vi.stubGlobal('window', {
        ...window,
        location: { origin: 'http://localhost:5188', hostname: 'localhost' },
      });
    ...
    it('allows authorized subdomain', () => {
      vi.stubGlobal('window', {
        ...window,
        location: { origin: 'https://app.nextvwt.id', hostname: 'app.nextvwt.id' },
      });
      expect(checkDomainAuthorization()).toBe(true);
    });
    ...
    it('rejects unknown domain', () => {
      vi.stubGlobal('window', {
        ...window,
        location: { origin: 'https://evil.com', hostname: 'evil.com' },
      });
